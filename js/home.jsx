        ...
        <section className="front-page">
          <div>
            <p style={{fontSize: 50, marginBottom: 20}} className="centered">
              <a href="/rm_mj" target="_blank" className="highlight-link">tickets</a> and <a href="https://www.artful.ly/two-headed-rep/store/passes" target="_blank" className="highlight-link">passes</a> on sale now!
            </p>
